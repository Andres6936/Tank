...
export const formatterCurrency = (currency: string) => new Intl.NumberFormat("es-CO", {
    style: "currency",
    currency,
...
export const isEmptyNullOrUndefined = (value: string | undefined | null): value is '' | null | undefined =>
