...
export default function WaterTank() {
  ...
  return (
    <section
      className={
        "flex flex-col flex-basis:99.3% flex-basis:49.3%@sm flex-basis:33%@md justify-content:center align-items:center p:0.5em py:2em max-w:45rem"
      }
    >
      <div
        className={
          "flex position:relative justify-content:center w:20rem max-w:20rem"
        }
      >
        ...
        <Thermostat
          ...
          onChange={(newValue) =>
            onChangeWaterLevel(Number(newValue.toFixed(0)))
          }
          track={{
