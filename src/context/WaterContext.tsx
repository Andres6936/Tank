...
export interface IWaterContext {
  ...
  setHighLevelAlarm: (value: number) => void;
  setLowLevelAlarm: (value: number) => void;
...
export const WaterContext = createContext<IWaterContext>({
  ...
  setHighLevelAlarm: () => console.log("Not Implemented"),
  setLowLevelAlarm: () => console.log("Not Implemented"),
